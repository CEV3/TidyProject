...
The code used for this project is documented below. This document was written as an R markdown file and knitted with knitr into this markdown file. Github will render this file as HTML.
...
The key files used for the project were loaded using read.table. This was followed by exploratory analysis of the dimensions and structire of the data. Some of the steps were commented out due to space considerations, although the results are included in the comments.
...
The uniquePunct function was written to identify non-alphatetical and non-numeric characters appearing in the variable labels. There are functions in R to automate data clean-up, but the steps below provided more control.
...
uniquePunct(newHeaders) # now just hyphens and periods
```
...
```
    ...
    ## [63] "Mean.fBodyAccJerkMag-mean"  "Mean.fBodyAccJerkMag-std"  
    ## [65] "Mean.fBodyGyroMag-mean"     "Mean.fBodyGyroMag-std"     
    ## [67] "Mean.fBodyGyroJerkMag-mean" "Mean.fBodyGyroJerkMag-std"
...
``` r
# Confirmed by comparning nrow tidy2 with nrow unique transposed tidy2, finding 2 fewer columns (65 vs. original 67) as expected.
